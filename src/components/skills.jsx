...
function Skills() {
  return (
    <div className=' w-full h-fit flex items-center flex-col justify-center' id='Competences' >
      <h1 className='text-center text-[2.2rem] skill'>Mes Compétences</h1>
      ...
      <div className='reveal  shadow-xl w-full flex items-center flex-col justify-center '>
            ...
            <div className='grid grid-cols-2 border-white border-2 p-5'>
                <div>
                    <div>
                ...
                <div>
                    ...
                    <div>
                        <h1 className='text-[1.5rem] items-center gap-x-2 flex'><GiConfirmed/> WORDPRESS</h1>
                        <p>Intermediare</p>
                    </div>
                </div>
            </div>
        ...
        <div className='reveal  shadow-xl   flex items-center flex-col justify-center w-100'>
            ...
            <div className='grid grid-cols-2 border-white border-2 p-5 gap-x-20'>
                <div>
                    <div>
                    ...
                    <div>
                        <h1 className='text-[1.5rem] items-center gap-x-2 flex'><GiConfirmed/> NEXTJS</h1>
                        <p>Debutant</p>
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <h1 className='text-[1.5rem] items-center gap-x-2 flex'><GiConfirmed/> SQL</h1>
                        <p>Intermediare</p>
                    </div>
                </div>
            </div>
